         ...
         validates: true,
          ...
          toggle: function(opts) {
            ...
            var args		= arguments[0],
                ...
                condition   = (this.nodeName === undefined)? 'M' : (tgtCnf || tgtCls || tgtTcls || tgtDim) ? 'C' : 'A';
            ...
            , draw: function(opts) {
                ...
                for (;setting.initN < dom.list.length; setting.initN++) {
                    ...
                    var tgtTp	=	(setting.initN < setting.deftR)
                                    ? 0 : Number(String.prototype.getMatrix.call(getComputedStyle(dom.list[setting.initN
                                        - setting.deftR])[setting.trsfm], 5))
                        , tgtHt	=	(setting.initN < setting.deftR)
                                    ? 0 : dom.list[setting.initN - setting.deftR].querySelector('img').clientHeight
